...
export default function Topnav(){
  ...
  return (
    <div>
      <nav className="flex flex-row justify-between border-b-0.15 hover:border-green-100">
        <div className="flex flex-row justify-center w-1/3 my-3">
          <div className="w-7">
        ...
        <div className="flex flex-row w-1/3 justify-center my-3">
        ...
        <div className="w-1/3 flex flex-row justify-center my-1">
          ...
          <button className="m-2 p-1 rounded-sm bg-green-400 text-white-500 text-xs font-mono font-bold">
            Lets talk
          </button>
        </div>
      </nav>
