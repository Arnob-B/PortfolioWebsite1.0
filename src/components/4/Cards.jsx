const Cards = ({
  ...
  return(
    <div className="flex flex-row bg-slate-600 items-center justify-evenly rounded-lg border-1 border-slate-300 my-2 px-2"> 
      <img src={logo} alt=" logo" className="bg-inherit w-14 h-14 mx-1 object-contain rounded-full border-1 border-slate-400"/>
...
export default function MainCards({type,title,cardlist}){
  console.log("cardlist is here",type," >> ",cardlist)
  let logo ;
  if(type == 'comp')
